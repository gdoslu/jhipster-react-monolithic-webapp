...
import xyz.repom.jhipster.react.monolithic.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("xyz.repom.jhipster.react.monolithic.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("xyz.repom.jhipster.react.monolithic.config.dbmigrations");
